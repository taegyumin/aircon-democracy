...
const styles = StyleSheet.create({
  ...
  changeBtn: { height: SPACE.touchMin, paddingHorizontal: SPACE.s3 },
  ...
  lineChip: { paddingHorizontal: SPACE.s4, minHeight: SPACE.touchMin, justifyContent: 'center', backgroundColor: TOKEN.surface, borderWidth: 1.5, borderRadius: TOKEN.r.pill },
  unknown: {

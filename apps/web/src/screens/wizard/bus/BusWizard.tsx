...
import { ArrowRight, CheckIcon, SearchIcon, GpsIcon, BusGlyph, MiniBusIcon } from './icons';
...
// ICONS는 ./icons.tsx로 추출 (ArrowRight, CheckIcon, SearchIcon, GpsIcon, MapPinIcon, BusGlyph, MiniBusIcon).
